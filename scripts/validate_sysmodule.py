...
def validate_main_json(filepath):
    ...
    if missing:
        ...
        print("Please ensure the kernel_capabilities syscalls mapping includes all up to 0x7F.")
        sys.exit(1)

    # Check for correct optimization patches
    if data.get("disable_device_address_space_merge") is False:
        print("WARNING: 'disable_device_address_space_merge' should usually be true for modern sysmodules.")
